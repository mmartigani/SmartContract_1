...
contract votacion{
    ...
    //constructor del propietario del contrato 
    //quien despliegue el contrato
    constructor () public{
        owner = msg.sender;
    }
    ...
    //es un hash porque es secreto y solo puedevotar una vez 
    // hash de la direccion por la que ha realizado la votacion 
    bytes32 [] votantes;
